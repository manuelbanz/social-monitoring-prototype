...
class Lib_Api_Mailchimp_ApiBase {
    ...
    */
     ...
     * @param array $options optional Various options for this merge var. <em>note:</em> for historical purposes this can also take a "boolean"
                    ...
                    boolean show optional indicates whether the field is displayed in the app's list member htdocs - defaults to true
     ...
     * string back that will explain our htdocs on what is going on.
     *
     * @section Helper
