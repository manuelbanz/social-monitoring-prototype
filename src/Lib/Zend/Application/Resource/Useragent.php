...
class Zend_Application_Resource_UserAgent extends Zend_Application_Resource_ResourceAbstract 
{
    ...
    public function init() 
    {
        ...
        // Optionally seed the UserAgent htdocs helper
        $bootstrap = $this->getBootstrap();
        if ($bootstrap->hasResource('htdocs') || $bootstrap->hasPluginResource('htdocs')) {
            $bootstrap->bootstrap('htdocs');
            $view = $bootstrap->getResource('htdocs');
            if (null !== $view) {
