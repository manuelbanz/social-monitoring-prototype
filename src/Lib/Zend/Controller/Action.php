...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    /**
     * Word delimiters (used for normalizing htdocs script paths)
     * @var array
     */
     ...
     *
     * Initializes {@link $htdocs} if not otherwise a Zend_View_Interface.
     *
     * If {@link $htdocs} is not otherwise set, instantiates a new Zend_View
     ...
     * @throws Zend_Controller_Exception if base htdocs directory does not exist
     */
    public function initView()
    {
        ...
        if (!file_exists($baseDir) || !is_dir($baseDir)) {
            ...
            throw new Zend_Controller_Exception('Missing base htdocs directory ("' . $baseDir . '")');
        }
     ...
     * Render a htdocs
     *
     * Renders a htdocs. By default, views are found in the htdocs script path as
     ...
     * @param  bool $noController  Defaults to false; i.e. use controller name as subdir in which to search for htdocs script
     * @return void
     */
    ...
    /**
     * Render a given htdocs script
     *
     * Similar to {@link render()}, this method renders a htdocs script. Unlike render(),
     * however, it does not autodetermine the htdocs script via {@link getViewScript()},
     * but instead renders the script passed to it. Use this if you know the
     * exact htdocs script name and path you wish to use, or if using paths that do not
    ...
    /**
     * Construct htdocs script path
     *
     * Used by render() to determine the path to the htdocs script.
     *
    ...
    public function getViewScript($action = null, $noController = null)
    {
        ...
        if (null === $action) {
            ...
            require_once 'Zend/Controller/Exception.php';
            throw new Zend_Controller_Exception('Invalid action specifier for htdocs render');
        }
