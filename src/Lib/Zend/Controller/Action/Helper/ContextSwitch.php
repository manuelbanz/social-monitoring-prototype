...
class Zend_Controller_Action_Helper_ContextSwitch extends Zend_Controller_Action_Helper_Abstract
{
    ...
    /**
     * Original htdocs suffix prior to detecting context switch
     * @var string
     */
     ...
     *
     * Reset the htdocs script suffix to the original state, or store the
     * original state.
     *
     * @return void
     */
    ...
    /**
     * Customize htdocs script suffix to use when switching context.
     *
     * Passing an empty suffix value to the setters disables the htdocs script
     * suffix change.
     *
     ...
     *
     * JSON serialize htdocs variables to response body
     *
     * @return void
     */
    public function postJsonContext()
    {
        ...
        if ($view instanceof Zend_View_Interface) {
            ...
            if(method_exists($view, 'getVars')) {
                ...
                require_once 'Zend/Controller/Action/Exception.php';
                throw new Zend_Controller_Action_Exception('View does not implement the getVars() method needed to encode the htdocs into JSON');
            }
        }
    }
