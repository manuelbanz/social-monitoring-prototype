    ...
    public function create($name, $indexActionIncluded = true, $module = null)
    {
        ...
        if ($request->isPretend()) {
            ...
            if (isset($indexActionResource)) {
                ...
                $response->appendContent('Would create a htdocs script for the index action method at ' . $indexActionViewResource->getContext()->getPath());
            }
            ...
            if (isset($indexActionResource)) {
                ...
                $response->appendContent('Creating a htdocs script for the index action method at ' . $indexActionViewResource->getContext()->getPath());
