...
{
    /**
     * Flag: whether or not to consume JS aggregated in the dojo() htdocs
     ...
     * with the dojo() htdocs helper when generating the module layer file
     * contents
     * @var bool
     */
    ...
    /**
     * Set dojo() htdocs helper instance
     *
    ...
    /**
     * Retrieve dojo() htdocs helper instance
     *
     * Will retrieve it from the htdocs object if not registered.
     *
     * @return Zend_Dojo_View_Helper_Dojo_Container
     * @throws Zend_Dojo_Exception if not registered and no htdocs object found
     */
     ...
     * aggregated in dojo() htdocs helper
     *
     * @param  bool $flag
     * @return Zend_Dojo_BuildLayer
     */
    ...
    /**
     * Get flag indicating whether or not to consume dojo.addOnLoad events aggregated in dojo() htdocs helper
     *
     * @return bool
     */
