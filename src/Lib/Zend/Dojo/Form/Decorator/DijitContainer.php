 ...
 *
 * Render a dojo dijit layout container via a htdocs helper
 *
 * Accepts the following options:
 * - helper:    the name of the htdocs helper to use
 *
 * Assumes the htdocs helper accepts four parameters, the id, content, dijit
...
abstract class Zend_Dojo_Form_Decorator_DijitContainer extends Zend_Form_Decorator_Abstract
{
    ...
    /**
     * Get htdocs helper for rendering container
     *
     * @return string
     */
    public function getHelper()
    {
        if (null === $this->_helper) {
            ...
            throw new Zend_Form_Decorator_Exception('No htdocs helper specified fo DijitContainer decorator');
        }
        return $this->_helper;
    }
