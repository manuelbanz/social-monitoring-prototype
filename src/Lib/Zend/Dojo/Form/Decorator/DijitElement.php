 ...
 *
 * Render a dojo dijit element via a htdocs helper
 *
...
class Zend_Dojo_Form_Decorator_DijitElement extends Zend_Form_Decorator_ViewHelper
{
     ...
     *
     * Determine htdocs helper from 'helper' option, or, if none set, from
    ...
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new Zend_Form_Decorator_Exception('DijitElement decorator cannot render without a registered htdocs object');
        }
