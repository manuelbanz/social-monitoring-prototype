...
class Zend_Layout
{
    ...
    /**
     * Get current htdocs object
     *
     * If no htdocs object currently set, retrieves it from the ViewRenderer.
     *
     * @todo Set inflector from htdocs renderer at same time
    ...
    /**
     * Set layout htdocs script suffix
     *
    ...
    /**
     * Retrieve layout htdocs script suffix
     *
     * @return string
     */
     ...
     * layout variables to htdocs, determines layout name using inflector, and
     * renders layout htdocs script.
     *
