 ...
 * - helper: which htdocs helper to use when rendering form. Should accept three
...
{
    /**
     * Default htdocs helper
     * @var string
     */
    protected $_helper = 'form';

    /**
     * Set htdocs helper for rendering form
     *
     * @param  string $helper
    ...
    /**
     * Get htdocs helper for rendering form
     *
     * @return string
     */
