 ...
 *
 * Render a htdocs script as a decorator
 *
 * Accepts the options:
 * - separator: separator to use between htdocs script content and provided content (defaults to PHP_EOL)
 * - placement: whether to append or prepend htdocs script content to provided content (defaults to prepend)
 * - viewScript: htdocs script to use
 *
 * The htdocs script is rendered as a partial; the element being decorated is
...
class Zend_Form_Decorator_ViewScript extends Zend_Form_Decorator_Abstract
{
    ...
    public function render($content)
    {
        ...
        if (empty($viewScript)) {
            ...
            throw new Zend_Form_Exception('No htdocs script registered with ViewScript decorator');
        }
