 ...
 *
 * Decorate an element by using a htdocs helper to render it.
 *
 ...
 * - helper:    the name of the htdocs helper to use
 *
 * Assumes the htdocs helper accepts three parameters, the name, value, and
...
class Zend_Form_Decorator_ViewHelper extends Zend_Form_Decorator_Abstract
{
    ...
    /**
     * Set htdocs helper to use when rendering
     *
     * @param  string $helper
    ...
    /**
     * Retrieve htdocs helper for rendering element
     *
     * @return string
     */
    ...
    /**
     * Render an element using a htdocs helper
     *
     * Determine htdocs helper from 'viewHelper' option, or, if none set, from
     * the element type. Then call as
     * helper($element->getName(), $element->getValue(), $element->getAttribs())
     *
     * @param  string $content
     * @return string
     * @throws Zend_Form_Decorator_Exception if element or htdocs are not registered
     */
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new Zend_Form_Decorator_Exception('ViewHelper decorator cannot render without a registered htdocs object');
        }
