...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    /**
     * Flag indicating whether or not LFI protection for rendering htdocs scripts is enabled
     * @var bool
     */
    ...
    /**
     * Strict variables flag; when on, undefined variables accessed in the htdocs
    ...
    public function __construct($config = array())
    {
        ...
        // user-defined htdocs script path
    ...
    /**
     * Directly assigns a variable to the htdocs script.
     *
     ...
     *
     * If the helper class has a 'htdocs' property, sets it with the current htdocs
     * object.
     *
    ...
    /**
     * Adds to the stack of htdocs script paths in LIFO order.
     *
    ...
    /**
     * Resets the stack of htdocs script paths.
     *
    ...
    /**
     * Return full path to a htdocs script specified by $name
     *
     * @param  string $name
    ...
    public function getScriptPath($name)
    {
        try {
            ...
            if (strstr($e->getMessage(), 'no htdocs script directory set')) {
                throw $e;
            }
    ...
    /**
     * Assigns variables to the htdocs script via differing strategies.
     *
    ...
    /**
     * Processes a htdocs script and returns the output.
     *
    ...
    /**
     * Escapes a value for output in a htdocs script.
     *
     ...
     * to enforce strict variable handling in your htdocs scripts.
     *
     * @param  boolean $flag
     * @return Zend_View_Abstract
     */
    ...
    /**
     * Finds a htdocs script from the available directories.
     *
    ...
    protected function _script($name)
    {
        ...
        if (0 == count($this->_path['script'])) {
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception('no htdocs script directory set; unable to determine location for htdocs script');
            $e->setView($this);
            throw $e;
        }
    ...
    /**
     * Use to include the htdocs script in a scope that only allows public
     * members.
     *
     * @return mixed
     */
