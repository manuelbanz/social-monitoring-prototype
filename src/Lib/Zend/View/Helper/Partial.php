...
class Zend_View_Helper_Partial extends Zend_View_Helper_Abstract
{
     ...
     *
     * If the $model is an array, it is passed to the htdocs object's assign()
     * method.
     *
     ...
     * method to to the htdocs object's assign() method. Otherwise, the result of
     * get_object_vars() is passed.
     *
     * @param  string $name Name of htdocs script
     * @param  string|array $module If $model is empty, and $module is an array,
     *                              these are the variables to populate in the
     *                              htdocs. Otherwise, the module in which the
     *                              partial resides
     * @param  array $model Variables to populate in the htdocs
