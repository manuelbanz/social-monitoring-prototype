...
class Zend_View_Helper_PaginationControl
{
    ...
    /**
     * Sets the default htdocs partial.
     *
    ...
    /**
     * Gets the default htdocs partial
     *
     * @return string|array
     */
    ...
    /**
     * Render the provided pages.  This checks if $htdocs->paginator is set and,
    ...
    public function paginationControl(Zend_Paginator $paginator = null, $scrollingStyle = null, $partial = null, $params = null)
    {
        ...
        if ($partial === null) {
            if (self::$_defaultViewPartial === null) {
                 ...
                 */
                require_once 'Zend/View/Exception.php';
                $e = new Zend_View_Exception('No htdocs partial provided and no default set');
                $e->setView($this->view);
                throw $e;
            }
        ...
        if (is_array($partial)) {
            if (count($partial) != 2) {
                 ...
                 */
                require_once 'Zend/View/Exception.php';
                $e = new Zend_View_Exception('A htdocs partial supplied as an array must contain two values: the filename and its module');
                $e->setView($this->view);
                throw $e;
            }
