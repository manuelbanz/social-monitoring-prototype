...
{
    /**
     * The htdocs object that created this helper object.
     * @var Zend_View
     */
    public $view;
     ...
     * not already be set in the htdocs object, as well as to set default values.
    ...
    /**
     * Set a htdocs variable
     *
     * Checks to see if a $key is set in the htdocs object; if not, sets it to $value.
     *
     * @param  string $key
