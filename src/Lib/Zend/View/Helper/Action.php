...
class Zend_View_Helper_Action extends Zend_View_Helper_Abstract
{
    ...
    public function __construct()
    {
        ...
        if (empty($request) || empty($response)) {
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception('Action htdocs helper requires both a registered request and response object in the front controller instance');
            $e->setView($this->view);
            throw $e;
        }
    ...
    public function action($action, $controller, $module = null, array $params = array())
    {
        ...
        // clone the htdocs object to prevent over-writing of htdocs variables
