    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    /**
     * Partial htdocs script to use for rendering menu
     *
     * @var string|array
     */
    ...
    /**
     * Sets which partial htdocs script to use for rendering menu
     *
     * @param  string|array $partial             partial htdocs script or null. If
     *                                           an array is given, it is
     *                                           expected to contain two values;
     *                                           the partial htdocs script to use,
    ...
    /**
     * Returns partial htdocs script to use for rendering menu
     *
    ...
    /**
     * Renders the given $container by invoking the partial htdocs helper
     *
     * The container will simply be passed on as a model to the htdocs script
     * as-is, and will be available in the partial script as 'container', e.g.
     * <code>echo 'Number of pages: ', count($this->container);</code>.
     *
     * @param  Zend_Navigation_Container $container  [optional] container to
     *                                               pass to htdocs script. Default
     *                                               is to use the container
     *                                               registered in the helper.
     * @param  string|array             $partial     [optional] partial htdocs
                                  ...
                                  $partial = null)
    {
        ...
        if (empty($partial)) {
            ...
            $e = new Zend_View_Exception(
                'Unable to render menu: No partial htdocs script provided'
            );
            $e->setView($this->view);
            throw $e;
        }
        ...
        if (is_array($partial)) {
            if (count($partial) != 2) {
                require_once 'Zend/View/Exception.php';
                $e = new Zend_View_Exception(
                    'Unable to render menu: A htdocs partial supplied as '
                    .  'an array must contain two values: partial htdocs '
     ...
     *
     * If a partial htdocs is registered in the helper, the menu will be rendered
